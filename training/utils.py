...
def save_checkpoint(data_name, epoch, epochs_since_improvement, encoder, decoder, encoder_optimizer, decoder_optimizer,
    ...
    if not os.path.exists(_config.trained_models_folder):
        os.mkdir(_config.trained_models_folder  )
    filename = _config.trained_models_folder + 'checkpoint_' + data_name + '.pth.tar'
